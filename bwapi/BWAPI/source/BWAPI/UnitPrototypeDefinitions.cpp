...
namespace BWAPI
{
  namespace Prototypes
  {
    ...
    /** Neutral */
    UnitPrototype* Minerals1           = new UnitPrototype("Minerals1"               , BW::UnitType::Resource_MineralPatch1,     RaceType::Other,     0, 0);    
    UnitPrototype* Minerals2           = new UnitPrototype("Minerals2"               , BW::UnitType::Resource_MineralPatch2,     RaceType::Other,     0, 0);    
    UnitPrototype* Minerals3           = new UnitPrototype("Minerals3"               , BW::UnitType::Resource_MineralPatch3,     RaceType::Other,     0, 0);    
