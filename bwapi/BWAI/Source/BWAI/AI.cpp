...
namespace BWAI
{
  ...
  void AI::onFrame(void)
  {
    ...
    BWAPI::Broodwar->drawEllipse(BWAPI::CoordinateType::Map,BWAPI::Broodwar->self()->getStartLocation().x()*32+2*32,BWAPI::Broodwar->self()->getStartLocation().y()*32+3*16,50,80,BWAPI::Colors::Red,false);
