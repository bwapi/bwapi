...
namespace BWAPI
{
  ...
  namespace Orders
  {
    ...
    void init()
    {
      ...
      orderName[TerranBuildSelf.getID()] = "TerranBuildSelf";
      ...
      orderName[ProtossBuildSelf.getID()] = "ProtossBuildSelf";
