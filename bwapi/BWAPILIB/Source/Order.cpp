...
namespace BWAPI
{
  ...
  namespace Orders
  {
    ...
    void init()
    {
      ...
      orderName[HarvestGas1.getID()]="HarvestGas1";
      orderName[HarvestGas2.getID()]="HarvestGas2";
      orderName[HarvestGas3.getID()]="HarvestGas3";
      orderName[ReturnGas.getID()]="ReturnGas";
      orderName[MoveToMinerals.getID()]="MoveToMinerals";
      orderName[HarvestMinerals2.getID()]="HarvestMinerals2";
      ...
      orderName[Hallucianation1.getID()]="Hallucianation1";
      ...
      orderSet.insert(HarvestGas1);
      orderSet.insert(HarvestGas2);
      orderSet.insert(HarvestGas3);
      orderSet.insert(ReturnGas);
      orderSet.insert(MoveToMinerals);
      orderSet.insert(HarvestMinerals2);
      ...
      orderSet.insert(Hallucianation1);
