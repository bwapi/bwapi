...
namespace BWAPI
{
  ...
  namespace Orders
  {
    ...
    const Order QueenHoldPosition(108);
    ...
    const Order SuicideHoldPosition(136);
    ...
    void init()
    {
      ...
      orderName[CarrierHoldPosition.getID()] = "CarrierHoldPosition";
      ...
      orderName[ReaverHoldPosition.getID()] = "ReaverHoldPosition";
      ...
      orderName[QueenHoldPosition.getID()] = "QueenHoldPosition";
      ...
      orderName[SuicideHoldPosition.getID()] = "SuicideHoldPosition";
      ...
      orderSet.insert(QueenHoldPosition);
      ...
      orderSet.insert(SuicideHoldPosition);
