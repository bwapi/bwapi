...
namespace BWAPI
{
  ...
  namespace TechTypes
  {
    ...
    void init()
    {
      ...
      techTypeData[Lockdown.getID()].set("Lockdown"                    ,200,200,1500,100,UnitTypes::Terran_Covert_Ops       ,Races::Terran ,WeaponTypes::Lockdown        ,UnitTypes::Terran_Ghost);
      techTypeData[EMP_Shockwave.getID()].set("EMP Shockwave"          ,200,200,1800,100,UnitTypes::Terran_Science_Facility ,Races::Terran ,WeaponTypes::EMP_Shockwave   ,UnitTypes::Terran_Science_Vessel);
      techTypeData[Spider_Mines.getID()].set("Spider Mines"            ,100,100,1200,0  ,UnitTypes::Terran_Machine_Shop     ,Races::Terran ,WeaponTypes::Spider_Mines    ,UnitTypes::Terran_Vulture);
      ...
      techTypeData[Tank_Siege_Mode.getID()].set("Tank Siege Mode"      ,150,150,1200,0  ,UnitTypes::Terran_Machine_Shop     ,Races::Terran ,WeaponTypes::None            ,UnitTypes::Terran_Siege_Tank_Tank_Mode,UnitTypes::Terran_Siege_Tank_Siege_Mode);
      techTypeData[Defensive_Matrix.getID()].set("Defensive Matrix"    ,0  ,0  ,0   ,100,UnitTypes::None                    ,Races::Terran ,WeaponTypes::None            ,UnitTypes::Terran_Science_Vessel);
      techTypeData[Irradiate.getID()].set("Irradiate"                  ,200,200,1200,75 ,UnitTypes::Terran_Science_Facility ,Races::Terran ,WeaponTypes::Irradiate       ,UnitTypes::Terran_Science_Vessel);
      techTypeData[Yamato_Gun.getID()].set("Yamato Gun"                ,100,100,1800,150,UnitTypes::Terran_Physics_Lab      ,Races::Terran ,WeaponTypes::Yamato_Gun      ,UnitTypes::Terran_Battlecruiser);
      techTypeData[Cloaking_Field.getID()].set("Cloaking Field"        ,150,150,1500,25 ,UnitTypes::Terran_Control_Tower    ,Races::Terran ,WeaponTypes::None            ,UnitTypes::Terran_Wraith);
      techTypeData[Personnel_Cloaking.getID()].set("Personnel Cloaking",100,100,1200,25 ,UnitTypes::Terran_Covert_Ops       ,Races::Terran ,WeaponTypes::None            ,UnitTypes::Terran_Ghost);
      techTypeData[Burrowing.getID()].set("Burrowing"                  ,100,100,1200,0  ,UnitTypes::Zerg_Hatchery           ,Races::Zerg   ,WeaponTypes::None            ,UnitTypes::Zerg_Drone                 ,UnitTypes::Zerg_Zergling,UnitTypes::Zerg_Hydralisk,UnitTypes::Zerg_Defiler);
      techTypeData[Infestation.getID()].set("Infestation"              ,0  ,0  ,0   ,0  ,UnitTypes::None                    ,Races::Zerg   ,WeaponTypes::None            ,UnitTypes::Zerg_Queen);
      techTypeData[Spawn_Broodlings.getID()].set("Spawn Broodlings"    ,100,100,1200,150,UnitTypes::Zerg_Queens_Nest        ,Races::Zerg   ,WeaponTypes::Spawn_Broodlings,UnitTypes::Zerg_Queen);
      techTypeData[Dark_Swarm.getID()].set("Dark Swarm"                ,0  ,0  ,0   ,100,UnitTypes::None                    ,Races::Zerg   ,WeaponTypes::Dark_Swarm      ,UnitTypes::Zerg_Defiler);
      techTypeData[Plague.getID()].set("Plague"                        ,200,200,1500,150,UnitTypes::Zerg_Defiler_Mound      ,Races::Zerg   ,WeaponTypes::Plague          ,UnitTypes::Zerg_Defiler);
      techTypeData[Consume.getID()].set("Consume"                      ,100,100,1500,0  ,UnitTypes::Zerg_Defiler_Mound      ,Races::Zerg   ,WeaponTypes::Consume         ,UnitTypes::Zerg_Defiler);
      techTypeData[Ensnare.getID()].set("Ensnare"                      ,100,100,1200,75 ,UnitTypes::Zerg_Queens_Nest        ,Races::Zerg   ,WeaponTypes::Ensnare         ,UnitTypes::Zerg_Queen);
      techTypeData[Parasite.getID()].set("Parasite"                    ,0  ,0  ,0   ,75 ,UnitTypes::None                    ,Races::Zerg   ,WeaponTypes::Parasite        ,UnitTypes::Zerg_Queen);
      techTypeData[Psionic_Storm.getID()].set("Psionic Storm"          ,200,200,1800,75 ,UnitTypes::Protoss_Templar_Archives,Races::Protoss,WeaponTypes::Psionic_Storm   ,UnitTypes::Protoss_High_Templar);
      techTypeData[Hallucination.getID()].set("Hallucination"          ,150,150,1200,100,UnitTypes::Protoss_Templar_Archives,Races::Protoss,WeaponTypes::None            ,UnitTypes::Protoss_High_Templar);
      techTypeData[Recall.getID()].set("Recall"                        ,150,150,1800,150,UnitTypes::Protoss_Arbiter_Tribunal,Races::Protoss,WeaponTypes::None            ,UnitTypes::Protoss_Arbiter);
      techTypeData[Stasis_Field.getID()].set("Stasis Field"            ,150,150,1500,100,UnitTypes::Protoss_Arbiter_Tribunal,Races::Protoss,WeaponTypes::Stasis_Field    ,UnitTypes::Protoss_Arbiter);
      ...
      techTypeData[Disruption_Web.getID()].set("Disruption Web"        ,200,200,1200,125,UnitTypes::Protoss_Fleet_Beacon    ,Races::Protoss,WeaponTypes::Disruption_Web  ,UnitTypes::Protoss_Corsair);
