...
namespace BWAPI
{
  ...
  namespace TechTypes
  {
    ...
    void init()
    {
      ...
      techTypeData[TechTypes::Stim_Packs.getID()].whatResearches=new BW::UnitType(BW::UnitID::Terran_Academy);
      ...
      techTypeData[TechTypes::Lockdown.getID()].whatResearches=new BW::UnitType(BW::UnitID::Terran_CovertOps);
      ...
      techTypeData[TechTypes::EMP_Shockwave.getID()].whatResearches=new BW::UnitType(BW::UnitID::Terran_ScienceFacility);
      ...
      techTypeData[TechTypes::Spider_Mines.getID()].whatResearches=new BW::UnitType(BW::UnitID::Terran_MachineShop);
      ...
      techTypeData[TechTypes::Scanner_Sweep.getID()].whatResearches=new BW::UnitType(BW::UnitID::None);
      ...
      techTypeData[TechTypes::Tank_Siege_Mode.getID()].whatResearches=new BW::UnitType(BW::UnitID::Terran_MachineShop);
      ...
      techTypeData[TechTypes::Defensive_Matrix.getID()].whatResearches=new BW::UnitType(BW::UnitID::None);
      ...
      techTypeData[TechTypes::Irradiate.getID()].whatResearches=new BW::UnitType(BW::UnitID::Terran_ScienceFacility);
      ...
      techTypeData[TechTypes::Yamato_Gun.getID()].whatResearches=new BW::UnitType(BW::UnitID::Terran_PhysicsLab);
      ...
      techTypeData[TechTypes::Cloaking_Field.getID()].whatResearches=new BW::UnitType(BW::UnitID::Terran_ControlTower);
      ...
      techTypeData[TechTypes::Personnel_Cloaking.getID()].whatResearches=new BW::UnitType(BW::UnitID::Terran_CovertOps);
      ...
      techTypeData[TechTypes::Burrowing.getID()].whatResearches=new BW::UnitType(BW::UnitID::Zerg_Hatchery);
      ...
      techTypeData[TechTypes::Infestation.getID()].whatResearches=new BW::UnitType(BW::UnitID::None);
      ...
      techTypeData[TechTypes::Spawn_Broodling.getID()].whatResearches=new BW::UnitType(BW::UnitID::Zerg_QueensNest);
      ...
      techTypeData[TechTypes::Dark_Swarm.getID()].whatResearches=new BW::UnitType(BW::UnitID::None);
      ...
      techTypeData[TechTypes::Plague.getID()].whatResearches=new BW::UnitType(BW::UnitID::None);
      ...
      techTypeData[TechTypes::Consume.getID()].whatResearches=new BW::UnitType(BW::UnitID::Zerg_DefilerMound);
      ...
      techTypeData[TechTypes::Ensnare.getID()].whatResearches=new BW::UnitType(BW::UnitID::Zerg_QueensNest);
      ...
      techTypeData[TechTypes::Parasite.getID()].whatResearches=new BW::UnitType(BW::UnitID::Zerg_QueensNest);
      ...
      techTypeData[TechTypes::Psionic_Storm.getID()].whatResearches=new BW::UnitType(BW::UnitID::Protoss_TemplarArchives);
      ...
      techTypeData[TechTypes::Hallucination.getID()].whatResearches=new BW::UnitType(BW::UnitID::Protoss_TemplarArchives);
      ...
      techTypeData[TechTypes::Recall.getID()].whatResearches=new BW::UnitType(BW::UnitID::Protoss_ArbiterTribunal);
      ...
      techTypeData[TechTypes::Stasis_Field.getID()].whatResearches=new BW::UnitType(BW::UnitID::Protoss_ArbiterTribunal);
      ...
      techTypeData[TechTypes::Archon_Warp.getID()].whatResearches=new BW::UnitType(BW::UnitID::None);
      ...
      techTypeData[TechTypes::Restoration.getID()].whatResearches=new BW::UnitType(BW::UnitID::None);
      ...
      techTypeData[TechTypes::Disruption_Web.getID()].whatResearches=new BW::UnitType(BW::UnitID::Protoss_FleetBeacon);
      ...
      techTypeData[TechTypes::Mind_Control.getID()].whatResearches=new BW::UnitType(BW::UnitID::Protoss_TemplarArchives);
      ...
      techTypeData[TechTypes::Dark_Archon_Meld.getID()].whatResearches=new BW::UnitType(BW::UnitID::None);
      ...
      techTypeData[TechTypes::Feedback.getID()].whatResearches=new BW::UnitType(BW::UnitID::None);
      ...
      techTypeData[TechTypes::Optical_Flare.getID()].whatResearches=new BW::UnitType(BW::UnitID::Terran_Academy);
      ...
      techTypeData[TechTypes::Maelstrom.getID()].whatResearches=new BW::UnitType(BW::UnitID::Protoss_TemplarArchives);
      ...
      techTypeData[TechTypes::Lurker_Aspect.getID()].whatResearches=new BW::UnitType(BW::UnitID::Zerg_HydraliskDen);
      ...
      techTypeData[TechTypes::Healing.getID()].whatResearches=new BW::UnitType(BW::UnitID::None);
      techTypeData[TechTypes::None.getID()].name="None";
      techTypeData[TechTypes::None.getID()].mineralPrice=0;
      techTypeData[TechTypes::None.getID()].gasPrice=0;
      techTypeData[TechTypes::None.getID()].energyPrice=0;
      techTypeData[TechTypes::None.getID()].whatResearches=new BW::UnitType(BW::UnitID::None);
      techTypeData[TechTypes::Unknown.getID()].name="Unknown";
      techTypeData[TechTypes::Unknown.getID()].mineralPrice=0;
      techTypeData[TechTypes::Unknown.getID()].gasPrice=0;
      techTypeData[TechTypes::Unknown.getID()].energyPrice=0;
      techTypeData[TechTypes::Unknown.getID()].whatResearches=new BW::UnitType(BW::UnitID::None);
