...
namespace BWAPI
{
  ...
  class TechTypeInternal
  {
    public:
      ...
      void set(const char* name, int mineralPrice, int gasPrice, int energyUsed, UnitType whatResearches, Race race, WeaponType weapon, UnitType whatUses1, UnitType whatUses2=UnitTypes::None, UnitType whatUses3=UnitTypes::None, UnitType whatUses4=UnitTypes::None)
      {
        this->name=name;
