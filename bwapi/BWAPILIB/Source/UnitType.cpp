...
namespace BWAPI
{
  ...
  namespace UnitTypes
  {
    ...
    void init()
    {
      ...
      unitTypeData[Zerg_Zergling.getID()].set("Zerg Zergling",Races::Zerg,&(Zerg_Larva),1,&(Zerg_Larva),1,&(Zerg_Spawning_Pool),1,NULL,0,NULL,1,0,8960,100,0,50,0,0,420,8,4,7,11,1,1,1,5,false,true,true,false,false,false,false,true,false);
      unitTypeData[Zerg_Hydralisk.getID()].set("Zerg Hydralisk",Races::Zerg,&(Zerg_Larva),1,&(Zerg_Larva),1,&(Zerg_Hydralisk_Den),1,NULL,0,NULL,2,0,20480,100,0,75,25,0,420,10,10,10,12,1,1,1,10,false,true,true,false,false,false,false,true,false);
      unitTypeData[Zerg_Ultralisk.getID()].set("Zerg Ultralisk",Races::Zerg,&(Zerg_Larva),1,&(Zerg_Larva),1,&(Zerg_Ultralisk_Cavern),1,NULL,0,NULL,8,0,36864,100,0,200,200,1,900,19,16,18,15,2,1,1,20,false,true,true,false,false,false,false,true,false);
      ...
      unitTypeData[Zerg_Drone.getID()].set("Zerg Drone",Races::Zerg,&(Zerg_Larva),1,&(Zerg_Larva),1,NULL,0,NULL,0,NULL,2,0,10240,100,0,50,0,0,300,11,11,11,11,1,1,1,5,false,true,true,false,false,false,false,true,false);
      unitTypeData[Zerg_Overlord.getID()].set("Zerg Overlord",Races::Zerg,&(Zerg_Larva),1,&(Zerg_Larva),1,NULL,0,NULL,0,NULL,0,16,51200,100,0,100,0,0,600,25,25,24,24,2,2,0,0,false,true,true,false,false,true,false,true,false);
      unitTypeData[Zerg_Mutalisk.getID()].set("Zerg Mutalisk",Races::Zerg,&(Zerg_Larva),1,&(Zerg_Larva),1,&(Zerg_Spire),1,NULL,0,NULL,4,0,30720,100,0,100,100,0,600,22,22,21,21,2,2,1,9,false,true,true,false,false,true,false,true,false);
      unitTypeData[Zerg_Guardian.getID()].set("Zerg Guardian",Races::Zerg,&(Zerg_Mutalisk),1,&(Zerg_Mutalisk),1,&(Zerg_Greater_Spire),1,NULL,0,NULL,4,0,38400,100,0,50,100,2,600,22,22,21,21,2,2,1,20,false,true,true,false,false,true,false,true,false);
      unitTypeData[Zerg_Queen.getID()].set("Zerg Queen",Races::Zerg,&(Zerg_Larva),1,&(Zerg_Larva),1,&(Zerg_Queens_Nest),1,NULL,0,NULL,4,0,30720,100,0,100,100,0,750,24,24,23,23,2,2,0,0,false,true,true,false,false,true,false,true,false);
      unitTypeData[Zerg_Defiler.getID()].set("Zerg Defiler",Races::Zerg,&(Zerg_Larva),1,&(Zerg_Larva),1,&(Zerg_Defiler_Mound),1,NULL,0,NULL,4,0,20480,100,0,50,150,1,750,13,12,13,12,1,1,0,0,false,true,true,false,false,false,false,true,false);
      unitTypeData[Zerg_Scourge.getID()].set("Zerg Scourge",Races::Zerg,&(Zerg_Larva),1,&(Zerg_Larva),1,&(Zerg_Spire),1,NULL,0,NULL,1,0,6400,100,0,25,75,0,450,12,12,11,11,1,1,0,0,false,true,true,false,false,true,false,true,false);
      ...
      unitTypeData[Zerg_Devourer.getID()].set("Zerg Devourer",Races::Zerg,&(Zerg_Mutalisk),1,&(Zerg_Mutalisk),1,&(Zerg_Greater_Spire),1,NULL,0,NULL,4,0,64000,100,0,150,50,2,600,22,22,21,21,2,2,0,0,false,true,true,false,false,true,false,true,false);
      ...
      unitTypeData[Zerg_Lurker_Egg.getID()].set("Zerg Lurker Egg",Races::Zerg,&(Zerg_Hydralisk),1,&(Zerg_Hydralisk),1,NULL,0,NULL,0,&(TechTypes::Lurker_Aspect),0,0,51200,0,0,1,1,10,1,16,16,15,15,1,1,0,0,false,false,false,false,false,false,false,true,false);
      unitTypeData[Zerg_Lurker.getID()].set("Zerg Lurker",Races::Zerg,&(Zerg_Hydralisk),1,&(Zerg_Hydralisk),1,NULL,0,NULL,0,&(TechTypes::Lurker_Aspect),4,0,32000,100,0,50,100,1,600,15,15,16,16,1,1,1,20,false,true,true,false,false,false,false,true,false);
