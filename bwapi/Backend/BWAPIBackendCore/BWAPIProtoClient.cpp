...
namespace BWAPI
{
  ...
  void BWAPIProtoClient::queueMessage(std::unique_ptr<SCRAPIProtocol::Request> newMessage)
  {
  ...
  bool BWAPIProtoClient::isRemaster() const
  {
    return remaster;
  }
  ...
  int BWAPIProtoClient::responseQueueSize() const
  {
  ...
  std::unique_ptr<SCRAPIProtocol::Response> BWAPIProtoClient::getNextResponse()
  {
