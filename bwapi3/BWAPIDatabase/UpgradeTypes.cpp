...
namespace BWAPI
{
  ...
  void fillUpgradeType(UpgradeTypeId id, const char* name, int mineralPriceBase, int mineralPriceFactor, int gasPriceBase, int gasPriceFactor, int upgradeTimeBase, int upgradeTimeFactor, BWAPI::UnitTypeId whatUpgrades, Race race, BWAPI::UnitTypeId whatUses, int maxRepeats)
  {
