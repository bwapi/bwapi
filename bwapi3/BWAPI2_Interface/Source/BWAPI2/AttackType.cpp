...
namespace BWAPI2
{
  ...
  {
    BWAPI2_EXPORT const AttackType Melee(0);
    BWAPI2_EXPORT const AttackType Fusion_Cutter_Hit(141);
    BWAPI2_EXPORT const AttackType Gauss_Rifle_Hit(142);
    BWAPI2_EXPORT const AttackType C_10_Canister_Rifle_Hit(143);
    BWAPI2_EXPORT const AttackType Gemini_Missiles(144);
    BWAPI2_EXPORT const AttackType Fragmentation_Grenade(145);
    BWAPI2_EXPORT const AttackType Longbolt_Missile(146);
    BWAPI2_EXPORT const AttackType ATS_ATA_Laser_Battery(148);
    BWAPI2_EXPORT const AttackType Burst_Lasers(149);
    BWAPI2_EXPORT const AttackType Arclite_Shock_Cannon_Hit(150);
    BWAPI2_EXPORT const AttackType EMP_Missile(151);
    BWAPI2_EXPORT const AttackType Dual_Photon_Blasters_Hit(152);
    BWAPI2_EXPORT const AttackType Particle_Beam_Hit(153);
    BWAPI2_EXPORT const AttackType Anti_Matter_Missile(154);
    BWAPI2_EXPORT const AttackType Pulse_Cannon(155);
    BWAPI2_EXPORT const AttackType Psionic_Shockwave_Hit(156);
    BWAPI2_EXPORT const AttackType Psionic_Storm(157);
    BWAPI2_EXPORT const AttackType Yamato_Gun(158);
    BWAPI2_EXPORT const AttackType Phase_Disruptor(159);
    BWAPI2_EXPORT const AttackType STA_STS_Cannon_Overlay(160);
    BWAPI2_EXPORT const AttackType Sunken_Colony_Tentacle(161);
    BWAPI2_EXPORT const AttackType Acid_Spore(163);
    BWAPI2_EXPORT const AttackType Glave_Wurm(165);
    BWAPI2_EXPORT const AttackType Seeker_Spores(166);
    BWAPI2_EXPORT const AttackType Queen_Spell_Carrier(167);
    BWAPI2_EXPORT const AttackType Plague_Cloud(168);
    BWAPI2_EXPORT const AttackType Consume(169);
    BWAPI2_EXPORT const AttackType Needle_Spine_Hit(171);
    BWAPI2_EXPORT const AttackType Invisible(172);
    BWAPI2_EXPORT const AttackType Optical_Flare_Grenade(201);
    BWAPI2_EXPORT const AttackType Halo_Rockets(202);
    BWAPI2_EXPORT const AttackType Subterranean_Spines(203);
    BWAPI2_EXPORT const AttackType Corrosive_Acid_Shot(204);
    BWAPI2_EXPORT const AttackType Neutron_Flare(206);
    BWAPI2_EXPORT const AttackType None(209);
    BWAPI2_EXPORT const AttackType Unknown(210);
    void init()
    {
