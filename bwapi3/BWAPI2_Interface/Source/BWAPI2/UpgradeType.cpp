...
namespace BWAPI2
{
  ...
  class UpgradeTypeInternal
  {
    public:
      ...
      void set(const char* name, int mineralPriceBase, int mineralPriceFactor, int gasPriceBase, int gasPriceFactor, int upgradeTimeBase, int upgradeTimeFactor, const UnitType* whatUpgrades, Race race, const UnitType* whatUses, int maxRepeats)
      {
        if (initializingUpgradeType)
        {
          ...
          this->race = race;
          if (whatUses!=NULL && whatUses!=&(UnitTypes::None))
          {
  ...
  {
    BWAPI2_EXPORT const UpgradeType Terran_Infantry_Armor(0);
    BWAPI2_EXPORT const UpgradeType Terran_Vehicle_Plating(1);
    BWAPI2_EXPORT const UpgradeType Terran_Ship_Plating(2);
    BWAPI2_EXPORT const UpgradeType Zerg_Carapace(3);
    BWAPI2_EXPORT const UpgradeType Zerg_Flyer_Carapace(4);
    BWAPI2_EXPORT const UpgradeType Protoss_Armor(5);
    BWAPI2_EXPORT const UpgradeType Protoss_Plating(6);
    BWAPI2_EXPORT const UpgradeType Terran_Infantry_Weapons(7);
    BWAPI2_EXPORT const UpgradeType Terran_Vehicle_Weapons(8);
    BWAPI2_EXPORT const UpgradeType Terran_Ship_Weapons(9);
    BWAPI2_EXPORT const UpgradeType Zerg_Melee_Attacks(10);
    BWAPI2_EXPORT const UpgradeType Zerg_Missile_Attacks(11);
    BWAPI2_EXPORT const UpgradeType Zerg_Flyer_Attacks(12);
    BWAPI2_EXPORT const UpgradeType Protoss_Ground_Weapons(13);
    BWAPI2_EXPORT const UpgradeType Protoss_Air_Weapons(14);
    BWAPI2_EXPORT const UpgradeType Protoss_Plasma_Shields(15);
    BWAPI2_EXPORT const UpgradeType U_238_Shells(16);
    BWAPI2_EXPORT const UpgradeType Ion_Thrusters(17);
    BWAPI2_EXPORT const UpgradeType Titan_Reactor(19);
    BWAPI2_EXPORT const UpgradeType Ocular_Implants(20);
    BWAPI2_EXPORT const UpgradeType Moebius_Reactor(21);
    BWAPI2_EXPORT const UpgradeType Apollo_Reactor(22);
    BWAPI2_EXPORT const UpgradeType Colossus_Reactor(23);
    BWAPI2_EXPORT const UpgradeType Ventral_Sacs(24);
    BWAPI2_EXPORT const UpgradeType Antennae(25);
    BWAPI2_EXPORT const UpgradeType Pneumatized_Carapace(26);
    BWAPI2_EXPORT const UpgradeType Metabolic_Boost(27);
    BWAPI2_EXPORT const UpgradeType Adrenal_Glands(28);
    BWAPI2_EXPORT const UpgradeType Muscular_Augments(29);
    BWAPI2_EXPORT const UpgradeType Grooved_Spines(30);
    BWAPI2_EXPORT const UpgradeType Gamete_Meiosis(31);
    BWAPI2_EXPORT const UpgradeType Metasynaptic_Node(32);
    BWAPI2_EXPORT const UpgradeType Singularity_Charge(33);
    BWAPI2_EXPORT const UpgradeType Leg_Enhancements(34);
    BWAPI2_EXPORT const UpgradeType Scarab_Damage(35);
    BWAPI2_EXPORT const UpgradeType Reaver_Capacity(36);
    BWAPI2_EXPORT const UpgradeType Gravitic_Drive(37);
    BWAPI2_EXPORT const UpgradeType Sensor_Array(38);
    BWAPI2_EXPORT const UpgradeType Gravitic_Boosters(39);
    BWAPI2_EXPORT const UpgradeType Khaydarin_Amulet(40);
    BWAPI2_EXPORT const UpgradeType Apial_Sensors(41);
    BWAPI2_EXPORT const UpgradeType Gravitic_Thrusters(42);
    BWAPI2_EXPORT const UpgradeType Carrier_Capacity(43);
    BWAPI2_EXPORT const UpgradeType Khaydarin_Core(44);
    BWAPI2_EXPORT const UpgradeType Argus_Jewel(47);
    BWAPI2_EXPORT const UpgradeType Argus_Talisman(49);
    BWAPI2_EXPORT const UpgradeType Caduceus_Reactor(51);
    BWAPI2_EXPORT const UpgradeType Chitinous_Plating(52);
    BWAPI2_EXPORT const UpgradeType Anabolic_Synthesis(53);
    BWAPI2_EXPORT const UpgradeType Charon_Booster(54);
    BWAPI2_EXPORT const UpgradeType None(61);
    BWAPI2_EXPORT const UpgradeType Unknown(62);
    void init()
    {
  ...
  const std::set<const UnitType*>& UpgradeType::whatUses() const
  {
