...
namespace BWSL
{
  ...
  {
    BWSL_EXPORT const UpgradeType Terran_Infantry_Armor(0);
    BWSL_EXPORT const UpgradeType Terran_Vehicle_Plating(1);
    BWSL_EXPORT const UpgradeType Terran_Ship_Plating(2);
    BWSL_EXPORT const UpgradeType Zerg_Carapace(3);
    BWSL_EXPORT const UpgradeType Zerg_Flyer_Carapace(4);
    BWSL_EXPORT const UpgradeType Protoss_Armor(5);
    BWSL_EXPORT const UpgradeType Protoss_Plating(6);
    BWSL_EXPORT const UpgradeType Terran_Infantry_Weapons(7);
    BWSL_EXPORT const UpgradeType Terran_Vehicle_Weapons(8);
    BWSL_EXPORT const UpgradeType Terran_Ship_Weapons(9);
    BWSL_EXPORT const UpgradeType Zerg_Melee_Attacks(10);
    BWSL_EXPORT const UpgradeType Zerg_Missile_Attacks(11);
    BWSL_EXPORT const UpgradeType Zerg_Flyer_Attacks(12);
    BWSL_EXPORT const UpgradeType Protoss_Ground_Weapons(13);
    BWSL_EXPORT const UpgradeType Protoss_Air_Weapons(14);
    BWSL_EXPORT const UpgradeType Protoss_Plasma_Shields(15);
    BWSL_EXPORT const UpgradeType U_238_Shells(16);
    BWSL_EXPORT const UpgradeType Ion_Thrusters(17);
    BWSL_EXPORT const UpgradeType Titan_Reactor(19);
    BWSL_EXPORT const UpgradeType Ocular_Implants(20);
    BWSL_EXPORT const UpgradeType Moebius_Reactor(21);
    BWSL_EXPORT const UpgradeType Apollo_Reactor(22);
    BWSL_EXPORT const UpgradeType Colossus_Reactor(23);
    BWSL_EXPORT const UpgradeType Ventral_Sacs(24);
    BWSL_EXPORT const UpgradeType Antennae(25);
    BWSL_EXPORT const UpgradeType Pneumatized_Carapace(26);
    BWSL_EXPORT const UpgradeType Metabolic_Boost(27);
    BWSL_EXPORT const UpgradeType Adrenal_Glands(28);
    BWSL_EXPORT const UpgradeType Muscular_Augments(29);
    BWSL_EXPORT const UpgradeType Grooved_Spines(30);
    BWSL_EXPORT const UpgradeType Gamete_Meiosis(31);
    BWSL_EXPORT const UpgradeType Metasynaptic_Node(32);
    BWSL_EXPORT const UpgradeType Singularity_Charge(33);
    BWSL_EXPORT const UpgradeType Leg_Enhancements(34);
    BWSL_EXPORT const UpgradeType Scarab_Damage(35);
    BWSL_EXPORT const UpgradeType Reaver_Capacity(36);
    BWSL_EXPORT const UpgradeType Gravitic_Drive(37);
    BWSL_EXPORT const UpgradeType Sensor_Array(38);
    BWSL_EXPORT const UpgradeType Gravitic_Boosters(39);
    BWSL_EXPORT const UpgradeType Khaydarin_Amulet(40);
    BWSL_EXPORT const UpgradeType Apial_Sensors(41);
    BWSL_EXPORT const UpgradeType Gravitic_Thrusters(42);
    BWSL_EXPORT const UpgradeType Carrier_Capacity(43);
    BWSL_EXPORT const UpgradeType Khaydarin_Core(44);
    BWSL_EXPORT const UpgradeType Argus_Jewel(47);
    BWSL_EXPORT const UpgradeType Argus_Talisman(49);
    BWSL_EXPORT const UpgradeType Caduceus_Reactor(51);
    BWSL_EXPORT const UpgradeType Chitinous_Plating(52);
    BWSL_EXPORT const UpgradeType Anabolic_Synthesis(53);
    BWSL_EXPORT const UpgradeType Charon_Booster(54);
    BWSL_EXPORT const UpgradeType None(61);
    BWSL_EXPORT const UpgradeType Unknown(62);
    void init()
    {
