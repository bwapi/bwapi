...
namespace BWSL
{
  ...
  {
    BWSL_EXPORT const UnitSizeType Independent(0);
    BWSL_EXPORT const UnitSizeType Small(1);
    BWSL_EXPORT const UnitSizeType Medium(2);
    BWSL_EXPORT const UnitSizeType Large(3);
    BWSL_EXPORT const UnitSizeType None(4);
    BWSL_EXPORT const UnitSizeType Unknown(5);
    void init()
    {
