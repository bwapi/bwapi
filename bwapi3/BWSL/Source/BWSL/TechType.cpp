...
namespace BWSL
{
  ...
  namespace TechTypes
  {
    BWSL_EXPORT const TechType Stim_Packs(0);
    BWSL_EXPORT const TechType Lockdown(1);
    BWSL_EXPORT const TechType EMP_Shockwave(2);
    BWSL_EXPORT const TechType Spider_Mines(3);
    BWSL_EXPORT const TechType Scanner_Sweep(4);
    BWSL_EXPORT const TechType Tank_Siege_Mode(5);
    BWSL_EXPORT const TechType Defensive_Matrix(6);
    BWSL_EXPORT const TechType Irradiate(7);
    BWSL_EXPORT const TechType Yamato_Gun(8);
    BWSL_EXPORT const TechType Cloaking_Field(9);
    BWSL_EXPORT const TechType Personnel_Cloaking(10);
    BWSL_EXPORT const TechType Burrowing(11);
    BWSL_EXPORT const TechType Infestation(12);
    BWSL_EXPORT const TechType Spawn_Broodlings(13);
    BWSL_EXPORT const TechType Dark_Swarm(14);
    BWSL_EXPORT const TechType Plague(15);
    BWSL_EXPORT const TechType Consume(16);
    BWSL_EXPORT const TechType Ensnare(17);
    BWSL_EXPORT const TechType Parasite(18);
    BWSL_EXPORT const TechType Psionic_Storm(19);
    BWSL_EXPORT const TechType Hallucination(20);
    BWSL_EXPORT const TechType Recall(21);
    BWSL_EXPORT const TechType Stasis_Field(22);
    BWSL_EXPORT const TechType Archon_Warp(23);
    BWSL_EXPORT const TechType Restoration(24);
    BWSL_EXPORT const TechType Disruption_Web(25);
    BWSL_EXPORT const TechType Mind_Control(27);
    BWSL_EXPORT const TechType Dark_Archon_Meld(28);
    BWSL_EXPORT const TechType Feedback(29);
    BWSL_EXPORT const TechType Optical_Flare(30);
    BWSL_EXPORT const TechType Maelstrom(31);
    BWSL_EXPORT const TechType Lurker_Aspect(32);
    BWSL_EXPORT const TechType Healing(34);
    BWSL_EXPORT const TechType None(44);
    BWSL_EXPORT const TechType Unknown(45);
    BWSL_EXPORT const TechType Nuclear_Strike(46);
    void init()
    {
