...
namespace BWSL
{
  ...
  {
    BWSL_EXPORT const ExplosionType None(0);
    BWSL_EXPORT const ExplosionType Normal(1);
    BWSL_EXPORT const ExplosionType Radial_Splash(2);
    BWSL_EXPORT const ExplosionType Enemy_Splash(3);
    BWSL_EXPORT const ExplosionType Lockdown(4);
    BWSL_EXPORT const ExplosionType Nuclear_Missile(5);
    BWSL_EXPORT const ExplosionType Parasite(6);
    BWSL_EXPORT const ExplosionType Broodlings(7);
    BWSL_EXPORT const ExplosionType EMP_Shockwave(8);
    BWSL_EXPORT const ExplosionType Irradiate(9);
    BWSL_EXPORT const ExplosionType Ensnare(10);
    BWSL_EXPORT const ExplosionType Plague(11);
    BWSL_EXPORT const ExplosionType Stasis_Field(12);
    BWSL_EXPORT const ExplosionType Dark_Swarm(13);
    BWSL_EXPORT const ExplosionType Consume(14);
    BWSL_EXPORT const ExplosionType Yamato_Gun(15);
    BWSL_EXPORT const ExplosionType Restoration(16);
    BWSL_EXPORT const ExplosionType Disruption_Web(17);
    BWSL_EXPORT const ExplosionType Corrosive_Acid(18);
    BWSL_EXPORT const ExplosionType Mind_Control(19);
    BWSL_EXPORT const ExplosionType Feedback(20);
    BWSL_EXPORT const ExplosionType Optical_Flare(21);
    BWSL_EXPORT const ExplosionType Maelstrom(22);
    BWSL_EXPORT const ExplosionType Air_Splash(24);
    BWSL_EXPORT const ExplosionType Unknown(25);
    void init()
    {
