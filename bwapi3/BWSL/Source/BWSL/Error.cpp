...
namespace BWSL
{
  ...
  namespace Errors
  {
    BWSL_EXPORT const Error Connection_Failure(21);
    BWSL_EXPORT const Error Unit_Does_Not_Exist(0);
    BWSL_EXPORT const Error Unit_Not_Visible(1);
    BWSL_EXPORT const Error Unit_Not_Owned(2);
    BWSL_EXPORT const Error Unit_Busy(3);
    BWSL_EXPORT const Error Incompatible_UnitType(4);
    BWSL_EXPORT const Error Incompatible_TechType(5);
    BWSL_EXPORT const Error Already_Researched(6);
    BWSL_EXPORT const Error Fully_Upgraded(7);
    BWSL_EXPORT const Error Insufficient_Minerals(8);
    BWSL_EXPORT const Error Insufficient_Gas(9);
    BWSL_EXPORT const Error Insufficient_Supply(10);
    BWSL_EXPORT const Error Insufficient_Energy(11);
    BWSL_EXPORT const Error Insufficient_Tech(12);
    BWSL_EXPORT const Error Insufficient_Ammo(13);
    BWSL_EXPORT const Error Insufficient_Space(14);
    BWSL_EXPORT const Error Unbuildable_Location(15);
    BWSL_EXPORT const Error Out_Of_Range(16);
    BWSL_EXPORT const Error Unable_To_Hit(17);
    BWSL_EXPORT const Error Access_Denied(18);
    BWSL_EXPORT const Error None(19);
    BWSL_EXPORT const Error Unknown(20);
    void init()
    {
