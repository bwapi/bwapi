...
namespace BWSL
{
  ...
  namespace Colors
  {
    BWSL_EXPORT const Color Red(111);
    BWSL_EXPORT const Color Green(117);
    BWSL_EXPORT const Color Blue(246);
    BWSL_EXPORT const Color Yellow(61);
    BWSL_EXPORT const Color Cyan(128);
    BWSL_EXPORT const Color Purple(163);
    BWSL_EXPORT const Color Orange(179);
    BWSL_EXPORT const Color Black(0);
    BWSL_EXPORT const Color White(255);
    BWSL_EXPORT const Color Grey(74);
