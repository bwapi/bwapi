...
namespace BWSL
{
  ...
  {
    BWSL_EXPORT const WeaponType Gauss_Rifle(0);
    BWSL_EXPORT const WeaponType C_10_Canister_Rifle(2);
    BWSL_EXPORT const WeaponType Fragmentation_Grenade(4);
    BWSL_EXPORT const WeaponType Spider_Mines(6);
    BWSL_EXPORT const WeaponType Twin_Autocannons(7);
    BWSL_EXPORT const WeaponType Hellfire_Missile_Pack(8);
    BWSL_EXPORT const WeaponType Arclite_Cannon(11);
    BWSL_EXPORT const WeaponType Fusion_Cutter(13);
    BWSL_EXPORT const WeaponType Gemini_Missiles(15);
    BWSL_EXPORT const WeaponType Burst_Lasers(16);
    BWSL_EXPORT const WeaponType ATS_Laser_Battery(19);
    BWSL_EXPORT const WeaponType ATA_Laser_Battery(20);
    BWSL_EXPORT const WeaponType Flame_Thrower(25);
    BWSL_EXPORT const WeaponType Arclite_Shock_Cannon(27);
    BWSL_EXPORT const WeaponType Longbolt_Missile(29);
    BWSL_EXPORT const WeaponType Claws(35);
    BWSL_EXPORT const WeaponType Needle_Spines(38);
    BWSL_EXPORT const WeaponType Kaiser_Blades(40);
    BWSL_EXPORT const WeaponType Toxic_Spores(42);
    BWSL_EXPORT const WeaponType Spines(43);
    BWSL_EXPORT const WeaponType Acid_Spore(46);
    BWSL_EXPORT const WeaponType Glave_Wurm(48);
    BWSL_EXPORT const WeaponType Seeker_Spores(52);
    BWSL_EXPORT const WeaponType Subterranean_Tentacle(53);
    BWSL_EXPORT const WeaponType Suicide_Infested_Terran(54);
    BWSL_EXPORT const WeaponType Suicide_Scourge(55);
    BWSL_EXPORT const WeaponType Particle_Beam(62);
    BWSL_EXPORT const WeaponType Psi_Blades(64);
    BWSL_EXPORT const WeaponType Phase_Disruptor(66);
    BWSL_EXPORT const WeaponType Psionic_Shockwave(70);
    BWSL_EXPORT const WeaponType Dual_Photon_Blasters(73);
    BWSL_EXPORT const WeaponType Anti_Matter_Missiles(74);
    BWSL_EXPORT const WeaponType Phase_Disruptor_Cannon(77);
    BWSL_EXPORT const WeaponType Pulse_Cannon(79);
    BWSL_EXPORT const WeaponType STS_Photon_Cannon(80);
    BWSL_EXPORT const WeaponType STA_Photon_Cannon(81);
    BWSL_EXPORT const WeaponType Scarab(82);
    BWSL_EXPORT const WeaponType Neutron_Flare(100);
    BWSL_EXPORT const WeaponType Halo_Rockets(103);
    BWSL_EXPORT const WeaponType Corrosive_Acid(104);
    BWSL_EXPORT const WeaponType Subterranean_Spines(109);
    BWSL_EXPORT const WeaponType Warp_Blades(111);

    BWSL_EXPORT const WeaponType Yamato_Gun(30);
    BWSL_EXPORT const WeaponType Nuclear_Strike(31);
    BWSL_EXPORT const WeaponType Lockdown(32);
    BWSL_EXPORT const WeaponType EMP_Shockwave(33);
    BWSL_EXPORT const WeaponType Irradiate(34);
    BWSL_EXPORT const WeaponType Parasite(56);
    BWSL_EXPORT const WeaponType Spawn_Broodlings(57);
    BWSL_EXPORT const WeaponType Ensnare(58);
    BWSL_EXPORT const WeaponType Dark_Swarm(59);
    BWSL_EXPORT const WeaponType Plague(60);
    BWSL_EXPORT const WeaponType Consume(61);
    BWSL_EXPORT const WeaponType Stasis_Field(83);
    BWSL_EXPORT const WeaponType Psionic_Storm(84);
    BWSL_EXPORT const WeaponType Disruption_Web(101);
    BWSL_EXPORT const WeaponType Restoration(102);
    BWSL_EXPORT const WeaponType Mind_Control(105);
    BWSL_EXPORT const WeaponType Feedback(106);
    BWSL_EXPORT const WeaponType Optical_Flare(107);
    BWSL_EXPORT const WeaponType Maelstrom(108);

    BWSL_EXPORT const WeaponType None(130);
    BWSL_EXPORT const WeaponType Unknown(131);
    void init()
    {
