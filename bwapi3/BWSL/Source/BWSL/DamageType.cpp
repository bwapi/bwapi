...
namespace BWSL
{
  ...
  {
    BWSL_EXPORT const DamageType Independent(0);
    BWSL_EXPORT const DamageType Explosive(1);
    BWSL_EXPORT const DamageType Concussive(2);
    BWSL_EXPORT const DamageType Normal(3);
    BWSL_EXPORT const DamageType Ignore_Armor(4);
    BWSL_EXPORT const DamageType None(5);
    BWSL_EXPORT const DamageType Unknown(6);
    void init()
    {
