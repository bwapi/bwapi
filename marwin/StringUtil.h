...
class StringUtil
 {
   ...
   * @param value Number to be converted to string.
   ...
   * @param begin Position of the first caracter of the number in the input string.
   * @param distance Maximum count of characters to read.
   * @return Returns textual representation of the specified string.
   */
  ...
  static std::string entitiesToMathMlEntities(std::string input);
